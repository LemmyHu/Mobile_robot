...
bool dynamixel_sdk_custom_interfaces__msg__status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dynamixel_sdk_custom_interfaces.msg._status.Status", full_classname_dest, 50) == 0);
  }
  dynamixel_sdk_custom_interfaces__msg__Status * ros_message = _ros_message;
  {  // ids
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dynamixel_sdk_custom_interfaces__msg__status__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Status */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dynamixel_sdk_custom_interfaces.msg._status");
  ...
  dynamixel_sdk_custom_interfaces__msg__Status * ros_message = (dynamixel_sdk_custom_interfaces__msg__Status *)raw_ros_message;
  {  // ids
    PyObject * field = NULL;
