...
dynamixel_sdk_custom_interfaces__msg__PresentLoad__init(dynamixel_sdk_custom_interfaces__msg__PresentLoad * msg)
{
  ...
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->ids, 0)) {
    dynamixel_sdk_custom_interfaces__msg__PresentLoad__fini(msg);
    return false;
  }
  // loads
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->loads, 0)) {
    dynamixel_sdk_custom_interfaces__msg__PresentLoad__fini(msg);
    return false;
  }
  return true;
...
dynamixel_sdk_custom_interfaces__msg__PresentLoad__fini(dynamixel_sdk_custom_interfaces__msg__PresentLoad * msg)
{
  ...
  // loads
  rosidl_runtime_c__int32__Sequence__fini(&msg->loads);
}
...
dynamixel_sdk_custom_interfaces__msg__PresentLoad__create()
{
  ...
  dynamixel_sdk_custom_interfaces__msg__PresentLoad * msg = (dynamixel_sdk_custom_interfaces__msg__PresentLoad *)allocator.allocate(sizeof(dynamixel_sdk_custom_interfaces__msg__PresentLoad), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dynamixel_sdk_custom_interfaces__msg__PresentLoad));
  bool success = dynamixel_sdk_custom_interfaces__msg__PresentLoad__init(msg);
  if (!success) {
...
dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence__init(dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_sdk_custom_interfaces__msg__PresentLoad * data = NULL;

  if (size) {
    data = (dynamixel_sdk_custom_interfaces__msg__PresentLoad *)allocator.zero_allocate(size, sizeof(dynamixel_sdk_custom_interfaces__msg__PresentLoad), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dynamixel_sdk_custom_interfaces__msg__PresentLoad__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dynamixel_sdk_custom_interfaces__msg__PresentLoad__fini(&data[i - 1]);
      }
...
dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence__fini(dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dynamixel_sdk_custom_interfaces__msg__PresentLoad__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence * array = (dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence *)allocator.allocate(sizeof(dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence__init(array, size);
  if (!success) {
...
dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence__destroy(dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence__are_equal(const dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence * lhs, const dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dynamixel_sdk_custom_interfaces__msg__PresentLoad__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dynamixel_sdk_custom_interfaces__msg__PresentLoad__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dynamixel_sdk_custom_interfaces__msg__PresentLoad);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    dynamixel_sdk_custom_interfaces__msg__PresentLoad * data =
      (dynamixel_sdk_custom_interfaces__msg__PresentLoad *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dynamixel_sdk_custom_interfaces__msg__PresentLoad__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          dynamixel_sdk_custom_interfaces__msg__PresentLoad__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dynamixel_sdk_custom_interfaces__msg__PresentLoad__copy(
