...
size_t size_function__SetPosition__profile_velocities(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<int32_t> *>(untyped_member);
  return member->size();
}

const void * get_const_function__SetPosition__profile_velocities(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<int32_t> *>(untyped_member);
  return &member[index];
...
void * get_function__SetPosition__profile_velocities(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  return &member[index];
...
void fetch_function__SetPosition__profile_velocities(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int32_t *>(
    get_const_function__SetPosition__profile_velocities(untyped_member, index));
  auto & value = *reinterpret_cast<int32_t *>(untyped_value);
  value = item;
}

void assign_function__SetPosition__profile_velocities(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int32_t *>(
    get_function__SetPosition__profile_velocities(untyped_member, index));
  const auto & value = *reinterpret_cast<const int32_t *>(untyped_value);
  item = value;
}

void resize_function__SetPosition__profile_velocities(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  member->resize(size);
...
size_t size_function__SetPosition__goal_pwms(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<int32_t> *>(untyped_member);
  return member->size();
}

const void * get_const_function__SetPosition__goal_pwms(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<int32_t> *>(untyped_member);
  return &member[index];
...
void * get_function__SetPosition__goal_pwms(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  return &member[index];
...
void fetch_function__SetPosition__goal_pwms(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int32_t *>(
    get_const_function__SetPosition__goal_pwms(untyped_member, index));
  auto & value = *reinterpret_cast<int32_t *>(untyped_value);
  value = item;
}

void assign_function__SetPosition__goal_pwms(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int32_t *>(
    get_function__SetPosition__goal_pwms(untyped_member, index));
  const auto & value = *reinterpret_cast<const int32_t *>(untyped_value);
  item = value;
}

void resize_function__SetPosition__goal_pwms(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetPosition_message_member_array[4] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dynamixel_sdk_custom_interfaces::msg::SetPosition, profile_velocities),  // bytes offset in struct
    nullptr,  // default value
    size_function__SetPosition__profile_velocities,  // size() function pointer
    get_const_function__SetPosition__profile_velocities,  // get_const(index) function pointer
    get_function__SetPosition__profile_velocities,  // get(index) function pointer
    fetch_function__SetPosition__profile_velocities,  // fetch(index, &value) function pointer
    assign_function__SetPosition__profile_velocities,  // assign(index, value) function pointer
    resize_function__SetPosition__profile_velocities  // resize(index) function pointer
  },
  {
    "goal_pwms",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_INT32,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dynamixel_sdk_custom_interfaces::msg::SetPosition, goal_pwms),  // bytes offset in struct
    nullptr,  // default value
    size_function__SetPosition__goal_pwms,  // size() function pointer
    get_const_function__SetPosition__goal_pwms,  // get_const(index) function pointer
    get_function__SetPosition__goal_pwms,  // get(index) function pointer
    fetch_function__SetPosition__goal_pwms,  // fetch(index, &value) function pointer
    assign_function__SetPosition__goal_pwms,  // assign(index, value) function pointer
    resize_function__SetPosition__goal_pwms  // resize(index) function pointer
  }
};
