...
#include "rosidl_runtime_c/primitives_sequence.h"  // goal_pwms, ids, positions, profile_velocities
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // goal_pwms, ids, positions, profile_velocities
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: profile_velocities
  {
    size_t size = ros_message->profile_velocities.size;
    auto array_ptr = ros_message->profile_velocities.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }

  // Field name: goal_pwms
  {
    size_t size = ros_message->goal_pwms.size;
    auto array_ptr = ros_message->goal_pwms.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: profile_velocities
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->profile_velocities.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->profile_velocities);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->profile_velocities, size)) {
      fprintf(stderr, "failed to create array for field 'profile_velocities'");
      return false;
    }
    auto array_ptr = ros_message->profile_velocities.data;
    cdr.deserializeArray(array_ptr, size);
  ...
  // Field name: goal_pwms
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->goal_pwms.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->goal_pwms);
    }
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->goal_pwms, size)) {
      fprintf(stderr, "failed to create array for field 'goal_pwms'");
      return false;
    }
    auto array_ptr = ros_message->goal_pwms.data;
    cdr.deserializeArray(array_ptr, size);
  ...
  size_t current_alignment)
{
  ...
  // field.name profile_velocities
  {
    size_t array_size = ros_message->profile_velocities.size;
    auto array_ptr = ros_message->profile_velocities.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
  ...
  // field.name goal_pwms
  {
    size_t array_size = ros_message->goal_pwms.size;
    auto array_ptr = ros_message->goal_pwms.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
