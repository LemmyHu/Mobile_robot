...
struct SetPosition_
{
  ...
  using _profile_velocities_type =
    std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>>;
  _profile_velocities_type profile_velocities;
  using _goal_pwms_type =
    std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>>;
  _goal_pwms_type goal_pwms;
  ...
  Type & set__profile_velocities(
    const std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> & _arg)
  {
    this->profile_velocities = _arg;
    return *this;
  }
  Type & set__goal_pwms(
    const std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> & _arg)
  ...
  bool operator==(const SetPosition_ & other) const
  {
    ...
    if (this->profile_velocities != other.profile_velocities) {
      return false;
    }
    if (this->goal_pwms != other.goal_pwms) {
      return false;
    }
    return true;
  }
