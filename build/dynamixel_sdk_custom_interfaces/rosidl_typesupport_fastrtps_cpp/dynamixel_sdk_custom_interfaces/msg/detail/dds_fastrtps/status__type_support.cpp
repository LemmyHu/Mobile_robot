...
#include "dynamixel_sdk_custom_interfaces/msg/detail/status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dynamixel_sdk_custom_interfaces::msg::Status & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamixel_sdk_custom_interfaces::msg::Status & ros_message)
{
  // Member: ids
  {
    cdr >> ros_message.ids;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynamixel_sdk_custom_interfaces::msg::Status;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dynamixel_sdk_custom_interfaces::msg::Status *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynamixel_sdk_custom_interfaces::msg::Status *>(
    untyped_ros_message);
...
{
  return &dynamixel_sdk_custom_interfaces::msg::typesupport_fastrtps_cpp::_Status__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamixel_sdk_custom_interfaces, msg, Status)() {
  return &dynamixel_sdk_custom_interfaces::msg::typesupport_fastrtps_cpp::_Status__handle;
}
