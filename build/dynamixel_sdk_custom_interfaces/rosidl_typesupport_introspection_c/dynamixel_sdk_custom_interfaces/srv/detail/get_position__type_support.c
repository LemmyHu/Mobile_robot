...
size_t dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__size_function__GetPosition_Request__ids(
...
const void * dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__get_const_function__GetPosition_Request__ids(
...
void * dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__get_function__GetPosition_Request__ids(
...
void dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__fetch_function__GetPosition_Request__ids(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const uint8_t * item =
    ((const uint8_t *)
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__get_const_function__GetPosition_Request__ids(untyped_member, index));
  uint8_t * value =
    (uint8_t *)(untyped_value);
  *value = *item;
}

void dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__assign_function__GetPosition_Request__ids(
  void * untyped_member, size_t index, const void * untyped_value)
{
  uint8_t * item =
    ((uint8_t *)
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__get_function__GetPosition_Request__ids(untyped_member, index));
  const uint8_t * value =
    (const uint8_t *)(untyped_value);
  *item = *value;
}

bool dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__resize_function__GetPosition_Request__ids(
...
static rosidl_typesupport_introspection_c__MessageMember dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__GetPosition_Request_message_member_array[1] = {
  {
    ...
    offsetof(dynamixel_sdk_custom_interfaces__srv__GetPosition_Request, ids),  // bytes offset in struct
    NULL,  // default value
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__size_function__GetPosition_Request__ids,  // size() function pointer
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__get_const_function__GetPosition_Request__ids,  // get_const(index) function pointer
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__get_function__GetPosition_Request__ids,  // get(index) function pointer
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__fetch_function__GetPosition_Request__ids,  // fetch(index, &value) function pointer
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__assign_function__GetPosition_Request__ids,  // assign(index, value) function pointer
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Request__rosidl_typesupport_introspection_c__resize_function__GetPosition_Request__ids  // resize(index) function pointer
  }
};
...
size_t dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__size_function__GetPosition_Response__positions(
  const void * untyped_member)
{
...
const void * dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__get_const_function__GetPosition_Response__positions(
  const void * untyped_member, size_t index)
{
  const rosidl_runtime_c__int32__Sequence * member =
    (const rosidl_runtime_c__int32__Sequence *)(untyped_member);
...
void * dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__get_function__GetPosition_Response__positions(
  void * untyped_member, size_t index)
{
...
void dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__fetch_function__GetPosition_Response__positions(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const int32_t * item =
    ((const int32_t *)
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__get_const_function__GetPosition_Response__positions(untyped_member, index));
  int32_t * value =
    (int32_t *)(untyped_value);
  *value = *item;
}

void dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__assign_function__GetPosition_Response__positions(
  void * untyped_member, size_t index, const void * untyped_value)
{
  int32_t * item =
    ((int32_t *)
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__get_function__GetPosition_Response__positions(untyped_member, index));
  const int32_t * value =
    (const int32_t *)(untyped_value);
  *item = *value;
}

bool dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__resize_function__GetPosition_Response__positions(
  void * untyped_member, size_t size)
{
  rosidl_runtime_c__int32__Sequence * member =
    (rosidl_runtime_c__int32__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__GetPosition_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dynamixel_sdk_custom_interfaces__srv__GetPosition_Response, positions),  // bytes offset in struct
    NULL,  // default value
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__size_function__GetPosition_Response__positions,  // size() function pointer
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__get_const_function__GetPosition_Response__positions,  // get_const(index) function pointer
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__get_function__GetPosition_Response__positions,  // get(index) function pointer
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__fetch_function__GetPosition_Response__positions,  // fetch(index, &value) function pointer
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__assign_function__GetPosition_Response__positions,  // assign(index, value) function pointer
    dynamixel_sdk_custom_interfaces__srv__GetPosition_Response__rosidl_typesupport_introspection_c__resize_function__GetPosition_Response__positions  // resize(index) function pointer
  }
};
