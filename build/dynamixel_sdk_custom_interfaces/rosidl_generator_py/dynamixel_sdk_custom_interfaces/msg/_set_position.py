...
class SetPosition(metaclass=Metaclass_SetPosition):
    ...
    _fields_and_field_types = {
        ...
        'profile_velocities': 'sequence<int32>',
        'goal_pwms': 'sequence<int32>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.profile_velocities = array.array('i', kwargs.get('profile_velocities', []))
        self.goal_pwms = array.array('i', kwargs.get('goal_pwms', []))
    ...
    def __eq__(self, other):
        ...
        if self.positions != other.positions:
            return False
        if self.profile_velocities != other.profile_velocities:
            return False
        if self.goal_pwms != other.goal_pwms:
            return False
        return True
    ...
    @builtins.property
    def profile_velocities(self):
        """Message field 'profile_velocities'."""
        return self._profile_velocities

    @profile_velocities.setter
    def profile_velocities(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'i', \
                "The 'profile_velocities' array.array() must have the type code of 'i'"
            self._profile_velocities = value
            return
        if __debug__:
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= -2147483648 and val < 2147483648 for val in value)), \
                "The 'profile_velocities' field must be a set or sequence and each value of type 'int' and each integer in [-2147483648, 2147483647]"
        self._profile_velocities = array.array('i', value)

    @builtins.property
    def goal_pwms(self):
        """Message field 'goal_pwms'."""
        return self._goal_pwms

    @goal_pwms.setter
    def goal_pwms(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'i', \
                "The 'goal_pwms' array.array() must have the type code of 'i'"
            self._goal_pwms = value
            return
        if __debug__:
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= -2147483648 and val < 2147483648 for val in value)), \
                "The 'goal_pwms' field must be a set or sequence and each value of type 'int' and each integer in [-2147483648, 2147483647]"
        self._goal_pwms = array.array('i', value)
