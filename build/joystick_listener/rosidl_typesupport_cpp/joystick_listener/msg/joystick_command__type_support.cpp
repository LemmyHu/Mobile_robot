...
static const _JoystickCommand_type_support_symbol_names_t _JoystickCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, joystick_listener, msg, JoystickCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, joystick_listener, msg, JoystickCommand)),
  }
};
...
{
  return &::joystick_listener::msg::rosidl_typesupport_cpp::JoystickCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, joystick_listener, msg, JoystickCommand)() {
  return get_message_type_support_handle<joystick_listener::msg::JoystickCommand>();
}
