...
#include "joystick_listener/msg/detail/joystick_command__rosidl_typesupport_fastrtps_c.h"
...
#include "joystick_listener/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _JoystickCommand__ros_msg_type = joystick_listener__msg__JoystickCommand;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_joystick_listener
size_t get_serialized_size_joystick_listener__msg__JoystickCommand(
  const void * untyped_ros_message,
...
static uint32_t _JoystickCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_joystick_listener__msg__JoystickCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_joystick_listener
size_t max_serialized_size_joystick_listener__msg__JoystickCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = joystick_listener__msg__JoystickCommand;
    is_plain =
      (
...
static size_t _JoystickCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_joystick_listener__msg__JoystickCommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, joystick_listener, msg, JoystickCommand)() {
