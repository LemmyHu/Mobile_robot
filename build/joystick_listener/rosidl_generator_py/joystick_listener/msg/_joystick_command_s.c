...
bool joystick_listener__msg__joystick_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("joystick_listener.msg._joystick_command.JoystickCommand", full_classname_dest, 55) == 0);
  }
  joystick_listener__msg__JoystickCommand * ros_message = _ros_message;
  {  // mode
...
PyObject * joystick_listener__msg__joystick_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("joystick_listener.msg._joystick_command");
